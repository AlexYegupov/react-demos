    ...
    var html = ReactDOMServer.renderToStaticMarkup(React.createElement(
      ...
      React.createElement('div', {
        ...
        dangerouslySetInnerHTML: {
          __html: ReactDOMServer.renderToString(React.createElement(_app2.default, { items: props.items, url: req.url }))
        } }),
      React.createElement('script', { dangerouslySetInnerHTML: { __html: 'var APP_PROPS = ' + JSON.stringify(props) + ';' + 'var URL = ' + JSON.stringify(req.url) + ';'
        } }),
